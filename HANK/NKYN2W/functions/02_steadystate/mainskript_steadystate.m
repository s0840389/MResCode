...
[c_n_guess,m_n_star,c_a_guess,m_a_star,cap_a_star,psi_guess,joint_distr,R_fc,Wy_fc,We_fc,Profits_fc,Output,grid,par,qs]...
...
dimGI=size(unique(marginal_m),1);

if dimGI<mpar.nm
warning('Copula interpolation dimension reduced. Consider smaller money grid')
end
Copula = griddedInterpolant({marginal_m(1:dimGI),marginal_k(1:dimGI)',marginal_h},cum_dist(1:dimGI,1:dimGI,:),'spline');
