...
[excess,c_n_guess,m_n_star,c_a_guess,m_a_star,cap_a_star,psi_guess,joint_distr, R_fc,W_fc,Profits_fc,Output,N,qs,par,ly,le,Mg]=excessK(Kcand,c_a_guess,c_n_guess,psi_guess,joint_distr, grid,P_H,mpar,par,meshes);
...
[ N,R_fc,W_fc,Profits_fc,WW,RR,RBRB,Output,qs,par,ly,le,Mg] = factor_returns(meshes,grid,par,mpar);
